...
LOGIN_REDIRECT_URL = 'news_app:article_review_list'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'no-reply@newsapp.local')
INTERNAL_API_BASE_URL = os.getenv('INTERNAL_API_BASE_URL', 'http://127.0.0.1:8000').rstrip('/')
